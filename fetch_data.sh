...
csv2parquet "${tmp_dir}/${NPIDATA_FILENAME}.csv" "./data/inputs/${NPIDATA_FILENAME}.zstd.parquet" -s ~/tools/bedrock-data/nppes.schema --max-read-records 1 --max-row-group-size 2048 --compression=zstd && rm -rf ${tmp_dir}
